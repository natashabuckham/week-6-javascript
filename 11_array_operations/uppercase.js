...
const otherUppercasedNames = names.map(toUpperCase); // this doesn't work because toUpperCase is not defined (has to be chained after a variable)

console.log(uppercasedNames);

console.log(otherUppercasedNames);
